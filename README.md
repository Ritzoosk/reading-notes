# ![alt text](https://angular.io/assets/images/logos/angular/angular.svg "Logo Title Text 1")Author ![alt text](https://github.com/adam-p/markdown-here/raw/master/src/common/images/icon48.png "Logo Title Text 1")
Ted Knecht
